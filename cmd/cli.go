...
func init() {
	...
	cliCmd.Flags().StringVarP(&productId, "id", "i", "", "Prodcut ID")
	cliCmd.Flags().StringVarP(&productName, "product", "n", "", "Prodcut Name")
	cliCmd.Flags().Float64VarP(&productPrice, "price", "p", 0, "Prodcut Price")
